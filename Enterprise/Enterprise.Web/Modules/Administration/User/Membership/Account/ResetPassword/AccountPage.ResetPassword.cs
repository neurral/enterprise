    ...
    public partial class AccountController : Controller
    {
        ...
        public ActionResult ResetPassword(string t)
        {
            ...
            if (UseAdminLTELoginBox)
                return View(MVC.Views.Administration.User.Membership.Account.ResetPassword.AccountResetPassword_AdminLTE, new ResetPasswordModel { Token = t });
            else
                return View(MVC.Views.Administration.User.Membership.Account.ResetPassword.AccountResetPassword, new ResetPasswordModel { Token = t });
