    ...
    public partial class AccountController : Controller
    {
        ...
        public ActionResult Login(string activated)
        {
            ...
            if (UseAdminLTELoginBox)
                return View(MVC.Views.Administration.User.Membership.Account.AccountLogin_AdminLTE);
            else
                return View(MVC.Views.Administration.User.Membership.Account.AccountLogin);
        }
