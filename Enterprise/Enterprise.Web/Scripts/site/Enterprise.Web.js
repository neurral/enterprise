...
(function (Enterprise) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Enterprise.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
...
(function (Enterprise) {
    var TemplateGrid = /** @class */ (function (_super) {
        ...
        TemplateGrid.prototype.getSlickOptions = function () {
            var opt = _super.prototype.getSlickOptions.call(this);
            if (Enterprise.Utils.isMobile()) {
                opt.rowHeight = 50; //must have equivalent px in site.less for .slick-row
            }
            opt.frozenColumn = 0;
            return opt;
        };
        TemplateGrid.prototype.getCssClass = function () {
            var klass = Q.trimToEmpty(_super.prototype.getCssClass.call(this));
        ...
        TemplateGrid.prototype.getColumns = function () {
            ...
            columns.unshift({
                ...
                name: '',
                format: function (ctx) {
                    return '<a class="grid-action action-open btn btn-primary" title="view details">View</a>';
                },
                width: 80,
                maxWidth: 100
            });
...
(function (Enterprise) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = Enterprise.LanguageList.getValue;
    })(ScriptInitialization = Enterprise.ScriptInitialization || (Enterprise.ScriptInitialization = {}));
})(Enterprise || (Enterprise = {}));
(function (Enterprise) {
    var Options = /** @class */ (function () {
        ...
        Options.PlugVegas = function (jquerySelector) {
            //element is usually just 'body'. make sure vegas.js is included in the cshtml.
            $(jquerySelector).vegas(new Options().VegasSlides());
        };
        return Options;
    }());
    Enterprise.Options = Options;
    var Utils = /** @class */ (function () {
        ...
        Utils.getUser = function () {
            return Enterprise.Authorization.userDefinition;
        };
        Utils.getPersonnelRecord = function (userId) {
            return Enterprise.Administration.UserService.GetPersonnelRecord({
                EntityId: userId
            }, function (response) { return response.Entity; });
        };
        return Utils;
    }());
    Enterprise.Utils = Utils;
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    /**
     ...
     */
    var ApprovalStatusEditor = /** @class */ (function (_super) {
        __extends(ApprovalStatusEditor, _super);
        function ApprovalStatusEditor(container) {
    ...
    Enterprise.ApprovalStatusEditor = ApprovalStatusEditor;
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    /**
    ...
    var BSToggleEditor = /** @class */ (function (_super) {
        __extends(BSToggleEditor, _super);
        function BSToggleEditor(element, opt) {
            ...
            if (opt) {
                if (opt.hideLabel) {
                    element.closest('.field').find('.caption').hide();
                }
        ...
        BSToggleEditor.prototype.get_value = function () {
            return this.element.is(":checked");
        };
        ;
        BSToggleEditor.prototype.set_value = function (value) {
            if (value) {
        ...
        ;
        BSToggleEditor = __decorate([
            Serenity.Decorators.registerEditor()
        ], BSToggleEditor);
        return BSToggleEditor;
    }(Serenity.BooleanEditor));
    Enterprise.BSToggleEditor = BSToggleEditor;
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var Common;
...
(function (Enterprise) {
    ...
    Enterprise.BasicProgressDialog = BasicProgressDialog;
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Enterprise.BasicProgressDialog();
...
(function (Enterprise) {
    ...
    })(DialogUtils = Enterprise.DialogUtils || (Enterprise.DialogUtils = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var Common;
    ...
    (function (Organization) {
        var PersonnelStatusDialog = /** @class */ (function (_super) {
            ...
            function PersonnelStatusDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Organization.PersonnelStatusForm(_this.idPrefix);
                return _this;
            }
            PersonnelStatusDialog.prototype.getFormKey = function () { return Organization.PersonnelStatusForm.formKey; };
            PersonnelStatusDialog.prototype.getIdProperty = function () { return Organization.PersonnelStatusRow.idProperty; };
            PersonnelStatusDialog.prototype.getLocalTextPrefix = function () { return Organization.PersonnelStatusRow.localTextPrefix; };
            PersonnelStatusDialog.prototype.getNameProperty = function () { return Organization.PersonnelStatusRow.nameProperty; };
            PersonnelStatusDialog.prototype.getService = function () { return Organization.PersonnelStatusService.baseUrl; };
            PersonnelStatusDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
...
(function (Enterprise) {
    var Organization;
    (function (Organization) {
        var PersonnelStatusEditor = /** @class */ (function (_super) {
            __extends(PersonnelStatusEditor, _super);
            function PersonnelStatusEditor(hidden) {
                return _super.call(this, hidden) || this;
            }
            PersonnelStatusEditor.prototype.getLookupKey = function () {
                return Organization.PersonnelStatusRow.lookupKey;
            };
            PersonnelStatusEditor.prototype.getItemText = function (item, lookup) {
                return _super.prototype.getItemText.call(this, item, lookup) + ' [' + item.PersonnelStatusId + ']';
            };
            PersonnelStatusEditor = __decorate([
                Serenity.Decorators.registerEditor()
            ], PersonnelStatusEditor);
            return PersonnelStatusEditor;
        }(Serenity.LookupEditorBase));
        Organization.PersonnelStatusEditor = PersonnelStatusEditor;
    })(Organization = Enterprise.Organization || (Enterprise.Organization = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var Organization;
    (function (Organization) {
        var PersonnelStatusGrid = /** @class */ (function (_super) {
            __extends(PersonnelStatusGrid, _super);
            function PersonnelStatusGrid(container) {
                return _super.call(this, container) || this;
            }
            PersonnelStatusGrid.prototype.getColumnsKey = function () { return 'Organization.PersonnelStatus'; };
            PersonnelStatusGrid.prototype.getDialogType = function () { return Organization.PersonnelStatusDialog; };
            PersonnelStatusGrid.prototype.getIdProperty = function () { return Organization.PersonnelStatusRow.idProperty; };
            PersonnelStatusGrid.prototype.getLocalTextPrefix = function () { return Organization.PersonnelStatusRow.localTextPrefix; };
            PersonnelStatusGrid.prototype.getService = function () { return Organization.PersonnelStatusService.baseUrl; };
            PersonnelStatusGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], PersonnelStatusGrid);
    ...
    (function (Organization) {
        var MeetingTypeDialog = /** @class */ (function (_super) {
            ...
            function MeetingTypeDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new MeetingTypeForm(_this.idPrefix);
                return _this;
            }
            MeetingTypeDialog.prototype.getFormKey = function () { return MeetingTypeForm.formKey; };
            MeetingTypeDialog.prototype.getIdProperty = function () { return MeetingTypeRow.idProperty; };
            MeetingTypeDialog.prototype.getLocalTextPrefix = function () { return MeetingTypeRow.localTextPrefix; };
            MeetingTypeDialog.prototype.getNameProperty = function () { return MeetingTypeRow.nameProperty; };
            MeetingTypeDialog.prototype.getService = function () { return MeetingTypeService.baseUrl; };
...
(function (Enterprise) {
    ...
    (function (Organization) {
        var MeetingTypeGrid = /** @class */ (function (_super) {
            ...
            MeetingTypeGrid.prototype.getColumnsKey = function () { return 'Organization.MeetingType'; };
            MeetingTypeGrid.prototype.getDialogType = function () { return Organization.MeetingTypeDialog; };
            MeetingTypeGrid.prototype.getIdProperty = function () { return MeetingTypeRow.idProperty; };
            MeetingTypeGrid.prototype.getLocalTextPrefix = function () { return MeetingTypeRow.localTextPrefix; };
            MeetingTypeGrid.prototype.getService = function () { return MeetingTypeService.baseUrl; };
    ...
    (function (Organization) {
        var MeetingLocationDialog = /** @class */ (function (_super) {
            ...
            function MeetingLocationDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new MeetingLocationForm(_this.idPrefix);
                return _this;
            }
            MeetingLocationDialog.prototype.getFormKey = function () { return MeetingLocationForm.formKey; };
            MeetingLocationDialog.prototype.getIdProperty = function () { return MeetingLocationRow.idProperty; };
            MeetingLocationDialog.prototype.getLocalTextPrefix = function () { return MeetingLocationRow.localTextPrefix; };
            MeetingLocationDialog.prototype.getNameProperty = function () { return MeetingLocationRow.nameProperty; };
            MeetingLocationDialog.prototype.getService = function () { return MeetingLocationService.baseUrl; };
...
(function (Enterprise) {
    ...
    (function (Organization) {
        var MeetingLocationGrid = /** @class */ (function (_super) {
            ...
            MeetingLocationGrid.prototype.getColumnsKey = function () { return 'Organization.MeetingLocation'; };
            MeetingLocationGrid.prototype.getDialogType = function () { return Organization.MeetingLocationDialog; };
            MeetingLocationGrid.prototype.getIdProperty = function () { return MeetingLocationRow.idProperty; };
            MeetingLocationGrid.prototype.getLocalTextPrefix = function () { return MeetingLocationRow.localTextPrefix; };
            MeetingLocationGrid.prototype.getService = function () { return MeetingLocationService.baseUrl; };
    ...
    (function (Organization) {
        var MeetingDecisionRelevantDialog = /** @class */ (function (_super) {
            ...
            function MeetingDecisionRelevantDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new MeetingDecisionRelevantForm(_this.idPrefix);
                return _this;
            }
            MeetingDecisionRelevantDialog.prototype.getFormKey = function () { return MeetingDecisionRelevantForm.formKey; };
            MeetingDecisionRelevantDialog.prototype.getIdProperty = function () { return MeetingDecisionRelevantRow.idProperty; };
            MeetingDecisionRelevantDialog.prototype.getLocalTextPrefix = function () { return MeetingDecisionRelevantRow.localTextPrefix; };
            MeetingDecisionRelevantDialog.prototype.getService = function () { return MeetingDecisionRelevantService.baseUrl; };
...
(function (Enterprise) {
    ...
    (function (Organization) {
        var MeetingDecisionRelevantGrid = /** @class */ (function (_super) {
            ...
            MeetingDecisionRelevantGrid.prototype.getColumnsKey = function () { return 'Organization.MeetingDecisionRelevant'; };
            MeetingDecisionRelevantGrid.prototype.getDialogType = function () { return Organization.MeetingDecisionRelevantDialog; };
            MeetingDecisionRelevantGrid.prototype.getIdProperty = function () { return MeetingDecisionRelevantRow.idProperty; };
            MeetingDecisionRelevantGrid.prototype.getLocalTextPrefix = function () { return MeetingDecisionRelevantRow.localTextPrefix; };
            MeetingDecisionRelevantGrid.prototype.getService = function () { return MeetingDecisionRelevantService.baseUrl; };
    ...
    (function (Organization) {
        var MeetingDecisionDialog = /** @class */ (function (_super) {
            ...
            function MeetingDecisionDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new MeetingDecisionForm(_this.idPrefix);
                return _this;
            }
            MeetingDecisionDialog.prototype.getFormKey = function () { return MeetingDecisionForm.formKey; };
            MeetingDecisionDialog.prototype.getIdProperty = function () { return MeetingDecisionRow.idProperty; };
            MeetingDecisionDialog.prototype.getLocalTextPrefix = function () { return MeetingDecisionRow.localTextPrefix; };
            MeetingDecisionDialog.prototype.getNameProperty = function () { return MeetingDecisionRow.nameProperty; };
            MeetingDecisionDialog.prototype.getService = function () { return MeetingDecisionService.baseUrl; };
...
(function (Enterprise) {
    ...
    (function (Organization) {
        var MeetingDecisionGrid = /** @class */ (function (_super) {
            ...
            MeetingDecisionGrid.prototype.getColumnsKey = function () { return 'Organization.MeetingDecision'; };
            MeetingDecisionGrid.prototype.getDialogType = function () { return Organization.MeetingDecisionDialog; };
            MeetingDecisionGrid.prototype.getIdProperty = function () { return MeetingDecisionRow.idProperty; };
            MeetingDecisionGrid.prototype.getLocalTextPrefix = function () { return MeetingDecisionRow.localTextPrefix; };
            MeetingDecisionGrid.prototype.getService = function () { return MeetingDecisionService.baseUrl; };
...
/// <reference path="../../../_Common/Helpers/GridEditorDialog.ts" />
var Enterprise;
(function (Enterprise) {
    var Organization;
    (function (Organization) {
        var MeetingAttendeeDialog = /** @class */ (function (_super) {
            ...
            function MeetingAttendeeDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new MeetingAttendeeForm(_this.idPrefix);
                return _this;
            }
            MeetingAttendeeDialog.prototype.getFormKey = function () { return MeetingAttendeeForm.formKey; };
            MeetingAttendeeDialog.prototype.getIdProperty = function () { return MeetingAttendeeRow.idProperty; };
            MeetingAttendeeDialog.prototype.getLocalTextPrefix = function () { return MeetingAttendeeRow.localTextPrefix; };
            MeetingAttendeeDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], MeetingAttendeeDialog);
            return MeetingAttendeeDialog;
        }(Enterprise.Common.GridEditorDialog));
        Organization.MeetingAttendeeDialog = MeetingAttendeeDialog;
    })(Organization = Enterprise.Organization || (Enterprise.Organization = {}));
})(Enterprise || (Enterprise = {}));
...
(function (Enterprise) {
    ...
    (function (Organization) {
        var MeetingAttendeeEditor = /** @class */ (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.getColumnsKey = function () { return 'Organization.MeetingAttendee'; };
            MeetingAttendeeEditor.prototype.getDialogType = function () { return Organization.MeetingAttendeeDialog; };
            MeetingAttendeeEditor.prototype.getLocalTextPrefix = function () { return MeetingAttendeeRow.localTextPrefix; };
        ...
        }(Enterprise.Common.GridEditorBase));
        Organization.MeetingAttendeeEditor = MeetingAttendeeEditor;
    })(Organization = Enterprise.Organization || (Enterprise.Organization = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    ...
    (function (Organization) {
        var MeetingAgendaTypeDialog = /** @class */ (function (_super) {
            ...
            function MeetingAgendaTypeDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new MeetingAgendaTypeForm(_this.idPrefix);
                return _this;
            }
            MeetingAgendaTypeDialog.prototype.getFormKey = function () { return MeetingAgendaTypeForm.formKey; };
            MeetingAgendaTypeDialog.prototype.getIdProperty = function () { return MeetingAgendaTypeRow.idProperty; };
            MeetingAgendaTypeDialog.prototype.getLocalTextPrefix = function () { return MeetingAgendaTypeRow.localTextPrefix; };
            MeetingAgendaTypeDialog.prototype.getNameProperty = function () { return MeetingAgendaTypeRow.nameProperty; };
            MeetingAgendaTypeDialog.prototype.getService = function () { return MeetingAgendaTypeService.baseUrl; };
...
(function (Enterprise) {
    ...
    (function (Organization) {
        var MeetingAgendaTypeGrid = /** @class */ (function (_super) {
            ...
            MeetingAgendaTypeGrid.prototype.getColumnsKey = function () { return 'Organization.MeetingAgendaType'; };
            MeetingAgendaTypeGrid.prototype.getDialogType = function () { return Organization.MeetingAgendaTypeDialog; };
            MeetingAgendaTypeGrid.prototype.getIdProperty = function () { return MeetingAgendaTypeRow.idProperty; };
            MeetingAgendaTypeGrid.prototype.getLocalTextPrefix = function () { return MeetingAgendaTypeRow.localTextPrefix; };
            MeetingAgendaTypeGrid.prototype.getService = function () { return MeetingAgendaTypeService.baseUrl; };
    ...
    (function (Organization) {
        var MeetingAgendaRelevantDialog = /** @class */ (function (_super) {
            ...
            function MeetingAgendaRelevantDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new MeetingAgendaRelevantForm(_this.idPrefix);
                return _this;
            }
            MeetingAgendaRelevantDialog.prototype.getFormKey = function () { return MeetingAgendaRelevantForm.formKey; };
            MeetingAgendaRelevantDialog.prototype.getIdProperty = function () { return MeetingAgendaRelevantRow.idProperty; };
            MeetingAgendaRelevantDialog.prototype.getLocalTextPrefix = function () { return MeetingAgendaRelevantRow.localTextPrefix; };
            MeetingAgendaRelevantDialog.prototype.getService = function () { return MeetingAgendaRelevantService.baseUrl; };
...
(function (Enterprise) {
    ...
    (function (Organization) {
        var MeetingAgendaRelevantGrid = /** @class */ (function (_super) {
            ...
            MeetingAgendaRelevantGrid.prototype.getColumnsKey = function () { return 'Organization.MeetingAgendaRelevant'; };
            MeetingAgendaRelevantGrid.prototype.getDialogType = function () { return Organization.MeetingAgendaRelevantDialog; };
            MeetingAgendaRelevantGrid.prototype.getIdProperty = function () { return MeetingAgendaRelevantRow.idProperty; };
            MeetingAgendaRelevantGrid.prototype.getLocalTextPrefix = function () { return MeetingAgendaRelevantRow.localTextPrefix; };
            MeetingAgendaRelevantGrid.prototype.getService = function () { return MeetingAgendaRelevantService.baseUrl; };
    ...
    (function (Organization) {
        var MeetingAgendaDialog = /** @class */ (function (_super) {
            ...
            function MeetingAgendaDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new MeetingAgendaForm(_this.idPrefix);
                return _this;
            }
            MeetingAgendaDialog.prototype.getFormKey = function () { return MeetingAgendaForm.formKey; };
            MeetingAgendaDialog.prototype.getIdProperty = function () { return MeetingAgendaRow.idProperty; };
            MeetingAgendaDialog.prototype.getLocalTextPrefix = function () { return MeetingAgendaRow.localTextPrefix; };
            MeetingAgendaDialog.prototype.getNameProperty = function () { return MeetingAgendaRow.nameProperty; };
            MeetingAgendaDialog.prototype.getService = function () { return MeetingAgendaService.baseUrl; };
...
(function (Enterprise) {
    ...
    (function (Organization) {
        var MeetingAgendaGrid = /** @class */ (function (_super) {
            ...
            MeetingAgendaGrid.prototype.getColumnsKey = function () { return 'Organization.MeetingAgenda'; };
            MeetingAgendaGrid.prototype.getDialogType = function () { return Organization.MeetingAgendaDialog; };
            MeetingAgendaGrid.prototype.getIdProperty = function () { return MeetingAgendaRow.idProperty; };
            MeetingAgendaGrid.prototype.getLocalTextPrefix = function () { return MeetingAgendaRow.localTextPrefix; };
            MeetingAgendaGrid.prototype.getService = function () { return MeetingAgendaService.baseUrl; };
...
(function (Enterprise) {
    ...
    (function (Organization) {
        var TimeRecordGrid = /** @class */ (function (_super) {
            ...
            TimeRecordGrid.prototype.addButtonClick = function () {
                var _this = this;
                Enterprise.Utils.getPersonnelRecord(Enterprise.Utils.getUser().UserId)
                    .then(function (res) {
                    _this.editItem({
                        PersonnelId: res.Entity.PersonnelId,
                        WorkDate: new Date().toUTCString()
                    });
                }, function (xhr, status, err) {
                    console.log(JSON.stringify(err));
                    _super.prototype.addButtonClick.call(_this);
                });
            };
...
(function (Enterprise) {
    ...
    (function (Northwind) {
        var TerritoryDialog = /** @class */ (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return Enterprise.LanguageList.getValue();
            };
    ...
    })(Northwind = Enterprise.Northwind || (Enterprise.Northwind = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var Northwind;
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(Enterprise.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Enterprise.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(Enterprise.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Enterprise.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Enterprise.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Enterprise.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        }(Enterprise.Northwind.OrderGrid));
        BasicSamples.WrappedHeadersGrid = WrappedHeadersGrid;
    })(BasicSamples = Enterprise.BasicSamples || (Enterprise.BasicSamples = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var BasicSamples;
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Enterprise.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Enterprise.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Enterprise.Northwind.SalesByCategoryService.baseUrl; };
            /**
        ...
        var TreeGrid = /** @class */ (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: Enterprise.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Enterprise.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Enterprise.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        }(Enterprise.Northwind.SupplierGrid));
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Enterprise.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Enterprise.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Enterprise.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Enterprise.Northwind.OrderService.baseUrl; };
            /**
            ...
            QuickFilterCustomization.prototype.getQuickFilters = function () {
                ...
                var fld = Enterprise.Northwind.OrderRow.Fields;
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        }(Enterprise.Northwind.ProductGrid));
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Enterprise.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Enterprise.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Enterprise.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Enterprise.Northwind.ProductService.baseUrl; };
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Enterprise.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
                        ...
                        var dlg = new Enterprise.Northwind.OrderDialog();
                        this.initDialog(dlg);
                        dlg.loadEntityAndOpenDialog({
        ...
        }(Enterprise.Northwind.CustomerGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = Enterprise.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
...
(function (Enterprise) {
    ...
    Enterprise.SelectableEntityGrid = SelectableEntityGrid;
})(Enterprise || (Enterprise = {}));
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Enterprise.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Enterprise.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Enterprise.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Enterprise.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Enterprise.SelectableEntityGrid));
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Enterprise.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Enterprise.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Enterprise.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Enterprise.Northwind.OrderDialog().loadEntityAndOpenDialog({
                        CustomerID: item.CustomerID,
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, Enterprise.Northwind.OrderRow.Fields.ShipCountry);
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Enterprise.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Enterprise.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Enterprise.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Enterprise.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = Enterprise.Northwind.ProductRow.Fields;
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        }(Enterprise.Common.BulkServiceAction));
...
(function (Enterprise) {
    ...
    Enterprise.StaticTextBlock = StaticTextBlock;
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var BasicSamples;
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        }(Enterprise.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Enterprise.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Enterprise.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = Enterprise.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(Enterprise.Northwind.OrderDetailDialog));
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        }(Enterprise.Northwind.OrderDetailsEditor));
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Enterprise.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Enterprise.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Enterprise.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Enterprise.Northwind.OrderService.baseUrl; };
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = Enterprise.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Enterprise.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Enterprise.Northwind.ProductRow.lookupKey;
            };
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Enterprise.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Enterprise.Northwind.CustomerDialog));
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Enterprise.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Enterprise.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Enterprise.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Enterprise.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Enterprise.Northwind.OrderService.baseUrl; };
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        }(Enterprise.Northwind.SupplierDialog));
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Enterprise.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Enterprise.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Enterprise.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Enterprise.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Enterprise.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Enterprise.Northwind.OrderService.baseUrl; };
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        var OtherFormOneBarDialog = /** @class */ (function (_super) {
            ...
            function OtherFormOneBarDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(Enterprise.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    idPrefix: _this.idPrefix + "_Customer_",
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Enterprise.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
            ...
            OtherFormOneBarDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Enterprise.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
            ...
            OtherFormOneBarDialog.prototype.saveCustomer = function (callback, onSuccess) {
                ...
                if (!id) {
                    ...
                    Enterprise.Northwind.CustomerService.Update({
                        EntityId: id,
                        Entity: c
                    }, function (response) {
                        // reload customer list just in case
                        Q.reloadLookup(Enterprise.Northwind.CustomerRow.lookupKey);
        ...
        }(Enterprise.Northwind.OrderDialog));
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Enterprise.Northwind.CategoryService.Retrieve({
        ...
        }(Enterprise.Northwind.CategoryDialog));
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        }(Enterprise.Northwind.CategoryGrid));
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Enterprise.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Enterprise.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var chai = Enterprise.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Enterprise.Northwind.EmployeeRow.getLookup().items
...
(function (Enterprise) {
    ...
    (function (Administration) {
        var UserDialog = /** @class */ (function (_super) {
            ...
            function UserDialog(option) {
                var _this = _super.call(this) || this;
                _this.form = new Administration.UserForm(_this.idPrefix);
                _this.profileMode = false;
                ...
                if (option) {
                    _this.profileMode = option.profileMode || false;
                }
                return _this;
            }
            UserDialog_1 = UserDialog;
            ...
            UserDialog.showProfile = function (userId) {
                (new UserDialog_1({ profileMode: true })).loadByIdAndOpenDialog(userId);
                //(new Enterprise.Organization.PersonnelDialog({ profileMode: true })).loadByIdAndOpenDialog(userId);               
            };
            UserDialog = UserDialog_1 = __decorate([
                Serenity.Decorators.registerClass()
            ], UserDialog);
            return UserDialog;
            var UserDialog_1;
...
(function (Enterprise) {
    ...
    })(Authorization = Enterprise.Authorization || (Enterprise.Authorization = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var Administration;
...
(function (Enterprise) {
    ...
    (function (ApprovalStatuses) {
        ApprovalStatuses[ApprovalStatuses["LOCKED"] = 0] = "LOCKED";
        ApprovalStatuses[ApprovalStatuses["SUBMITTED"] = 1] = "SUBMITTED";
        ApprovalStatuses[ApprovalStatuses["CANCELLED"] = 2] = "CANCELLED";
        ApprovalStatuses[ApprovalStatuses["APPROVED"] = 3] = "APPROVED";
        ApprovalStatuses[ApprovalStatuses["REJECTED"] = 4] = "REJECTED";
    })(ApprovalStatuses = Enterprise.ApprovalStatuses || (Enterprise.ApprovalStatuses = {}));
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return Enterprise.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Enterprise.BasicSamples || (Enterprise.BasicSamples = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return Enterprise.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return Enterprise.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Enterprise.BasicSamples || (Enterprise.BasicSamples = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
...
(function (Enterprise) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return Enterprise.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return Enterprise.StaticTextBlock; }], ['FromLocalText', function () { return Enterprise.StaticTextBlock; }], ['DisplayFieldValue', function () { return Enterprise.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Enterprise.BasicSamples || (Enterprise.BasicSamples = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
...
(function (Enterprise) {
    ...
    (function (DefaultRoles) {
        DefaultRoles[DefaultRoles["UNVERIFIED"] = 0] = "UNVERIFIED";
        DefaultRoles[DefaultRoles["ADMINISTRATOR"] = 1] = "ADMINISTRATOR";
        DefaultRoles[DefaultRoles["BOT"] = 2] = "BOT";
        DefaultRoles[DefaultRoles["ACCOUNT"] = 3] = "ACCOUNT";
        DefaultRoles[DefaultRoles["SUBACCOUNT"] = 4] = "SUBACCOUNT";
    })(DefaultRoles = Enterprise.DefaultRoles || (Enterprise.DefaultRoles = {}));
...
(function (Enterprise) {
    ...
    })(Gender = Enterprise.Gender || (Enterprise.Gender = {}));
    Serenity.Decorators.registerEnum(Gender, 'Enterprise.Constants+Gender');
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var Membership;
...
(function (Enterprise) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'Enterprise.Northwind.Entities.Gender');
    })(Northwind = Enterprise.Northwind || (Enterprise.Northwind = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
...
(function (Enterprise) {
    ...
    (function (Organization) {
        ...
        (function (CalendarHolidayRow) {
            ...
            CalendarHolidayRow.lookupKey = 'Organization.CalendarHoliday';
            function getLookup() {
                return Q.getLookup('Organization.CalendarHoliday');
            }
            CalendarHolidayRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
...
(function (Enterprise) {
    ...
    (function (Organization) {
        var PersonnelForm = /** @class */ (function (_super) {
            ...
            PersonnelForm.formKey = 'Organization.Personnel';
            return PersonnelForm;
        }(Serenity.PrefixedContext));
        Organization.PersonnelForm = PersonnelForm;
        [['FirstName', function () { return Serenity.StringEditor; }], ['LastName', function () { return Serenity.StringEditor; }], ['MiddleName', function () { return Serenity.StringEditor; }], ['Gender', function () { return Serenity.EnumEditor; }], ['DateOfBirth', function () { return Serenity.DateEditor; }], ['Email', function () { return Serenity.StringEditor; }], ['ContactNumber', function () { return Serenity.StringEditor; }], ['IdentificationNo', function () { return Serenity.StringEditor; }], ['PersonnelStatus', function () { return Serenity.LookupEditor; }], ['UserId', function () { return Serenity.LookupEditor; }], ['DateStarted', function () { return Serenity.DateEditor; }], ['DateExited', function () { return Serenity.DateEditor; }]].forEach(function (x) { return Object.defineProperty(PersonnelForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Organization = Enterprise.Organization || (Enterprise.Organization = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    ...
    (function (Organization) {
        ...
        (function (PersonnelRow) {
            ...
            PersonnelRow.nameProperty = 'FullName';
        ...
        })(PersonnelRow = Organization.PersonnelRow || (Organization.PersonnelRow = {}));
    })(Organization = Enterprise.Organization || (Enterprise.Organization = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    ...
    (function (Organization) {
        ...
        (function (PersonnelService) {
            PersonnelService.baseUrl = 'Organization/Personnel';
            var Methods;
            (function (Methods) {
            })(Methods = PersonnelService.Methods || (PersonnelService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                PersonnelService[x] = function (r, s, o) {
                    return Q.serviceRequest(PersonnelService.baseUrl + '/' + x, r, s, o);
                };
                Methods[x] = PersonnelService.baseUrl + '/' + x;
            });
        })(PersonnelService = Organization.PersonnelService || (Organization.PersonnelService = {}));
    })(Organization = Enterprise.Organization || (Enterprise.Organization = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var Organization;
    (function (Organization) {
        var PersonnelStatusForm = /** @class */ (function (_super) {
            __extends(PersonnelStatusForm, _super);
            function PersonnelStatusForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            PersonnelStatusForm.formKey = 'Organization.PersonnelStatus';
            return PersonnelStatusForm;
        }(Serenity.PrefixedContext));
        Organization.PersonnelStatusForm = PersonnelStatusForm;
        [['Sequence', function () { return Serenity.IntegerEditor; }], ['PersonnelStatusName', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(PersonnelStatusForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Organization = Enterprise.Organization || (Enterprise.Organization = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var Organization;
    (function (Organization) {
        var PersonnelStatusRow;
        (function (PersonnelStatusRow) {
            PersonnelStatusRow.idProperty = 'PersonnelStatusId';
            PersonnelStatusRow.nameProperty = 'PersonnelStatusName';
            PersonnelStatusRow.localTextPrefix = 'Organization.PersonnelStatus';
            PersonnelStatusRow.lookupKey = 'Organization.PersonnelStatus';
            function getLookup() {
                return Q.getLookup('Organization.PersonnelStatus');
            }
            PersonnelStatusRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
            })(Fields = PersonnelStatusRow.Fields || (PersonnelStatusRow.Fields = {}));
            [
                'PersonnelStatusId',
                'Sequence',
                'PersonnelStatusName'
            ].forEach(function (x) { return Fields[x] = x; });
        })(PersonnelStatusRow = Organization.PersonnelStatusRow || (Organization.PersonnelStatusRow = {}));
    })(Organization = Enterprise.Organization || (Enterprise.Organization = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var Organization;
    (function (Organization) {
        var PersonnelStatusService;
        (function (PersonnelStatusService) {
            PersonnelStatusService.baseUrl = 'Organization/PersonnelStatus';
            var Methods;
            (function (Methods) {
            })(Methods = PersonnelStatusService.Methods || (PersonnelStatusService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                PersonnelStatusService[x] = function (r, s, o) {
                    return Q.serviceRequest(PersonnelStatusService.baseUrl + '/' + x, r, s, o);
                };
...
(function (Enterprise) {
    ...
    (function (Organization) {
        ...
        [['TimeRecordId', function () { return Serenity.StringEditor; }], ['RequestorId', function () { return Serenity.StringEditor; }], ['ApprovalStatus', function () { return Serenity.EnumEditor; }], ['RequestorLocked', function () { return Serenity.BooleanEditor; }], ['ApproverLocked', function () { return Serenity.BooleanEditor; }], ['DateReviewed', function () { return Serenity.DateEditor; }]].forEach(function (x) { return Object.defineProperty(TimeRecordApprovalForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Organization = Enterprise.Organization || (Enterprise.Organization = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    ...
    (function (Organization) {
        ...
        (function (TimeRecordApprovalRow) {
            ...
            TimeRecordApprovalRow.nameProperty = 'RequestorFullName';
            TimeRecordApprovalRow.localTextPrefix = 'Organization.TimeRecordApproval';
            TimeRecordApprovalRow.lookupKey = 'Organization.TimeRecordApproval';
            function getLookup() {
                return Q.getLookup('Organization.TimeRecordApproval');
            }
            TimeRecordApprovalRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
...
(function (Enterprise) {
    ...
    (function (Organization) {
        ...
        [['PersonnelId', function () { return Serenity.LookupEditor; }], ['WorkDate', function () { return Serenity.DateEditor; }], ['TimeRecordTypeId', function () { return Serenity.LookupEditor; }], ['TimeStartInt', function () { return Serenity.TimeEditor; }], ['TimeEndInt', function () { return Serenity.TimeEditor; }], ['Remarks', function () { return Serenity.TextAreaEditor; }], ['Status', function () { return Serenity.EnumEditor; }]].forEach(function (x) { return Object.defineProperty(TimeRecordForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Organization = Enterprise.Organization || (Enterprise.Organization = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    ...
    (function (Organization) {
        ...
        (function (TimeRecordRow) {
            ...
            TimeRecordRow.lookupKey = 'Organization.TimeRecord';
            function getLookup() {
                return Q.getLookup('Organization.TimeRecord');
            }
            TimeRecordRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
...
(function (Enterprise) {
    ...
    (function (Organization) {
        ...
        (function (TimeRecordTypeRow) {
            ...
            TimeRecordTypeRow.lookupKey = 'Organization.PersonnelStatus';
            function getLookup() {
                return Q.getLookup('Organization.PersonnelStatus');
            }
            TimeRecordTypeRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
...
var Enterprise;
(function (Enterprise) {
    var PersonnelStatusIds;
    (function (PersonnelStatusIds) {
        PersonnelStatusIds[PersonnelStatusIds["UNVERIFIED"] = 1] = "UNVERIFIED";
        PersonnelStatusIds[PersonnelStatusIds["INACTIVE"] = 2] = "INACTIVE";
        PersonnelStatusIds[PersonnelStatusIds["ACTIVATED"] = 3] = "ACTIVATED";
        PersonnelStatusIds[PersonnelStatusIds["SUSPENDED"] = 4] = "SUSPENDED";
        PersonnelStatusIds[PersonnelStatusIds["TERMINATED"] = 5] = "TERMINATED";
    })(PersonnelStatusIds = Enterprise.PersonnelStatusIds || (Enterprise.PersonnelStatusIds = {}));
