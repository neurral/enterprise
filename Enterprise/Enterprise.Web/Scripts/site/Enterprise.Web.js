...
(function (Enterprise) {
    ...
    })(Meeting = Enterprise.Meeting || (Enterprise.Meeting = {}));
})(Enterprise || (Enterprise = {}));
var Enterprise;
(function (Enterprise) {
    var Meeting;
        ...
        var MeetingAttendeeEditor = /** @class */ (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: Enterprise.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = Enterprise.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
