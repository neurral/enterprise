    ...
    public class EnterpriseDB_20171126_010000_Timekeeping : AutoReversingMigration
    {
        ...
        public override void Up()
        {
            ...
            this.CreateTableWithId64("TimeRecord", "TimeRecordId", s => s
                ...
                .WithColumn("TimeRecordTypeId").AsInt64().NotNullable().WithDefaultValue(0)
                    .ForeignKey("FK_TimeRecord_TimeRecordTypeId", SCHEMA, "TimeRecordType", "TimeRecordTypeId")
            ...
            this.CreateTableWithId64("TimeRecordApproval", "ApprovalId", s => s
                ...
                .WithColumn("ApproverId").AsInt64().NotNullable()
                   .ForeignKey("FK_TimeRecordApproval_ApproverId", SCHEMA, "Personnel", "PersonnelId")
                .WithColumn("ApprovalStatus").AsInt16().NotNullable()
