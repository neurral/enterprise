namespace Enterprise.Organization {
    ...
    [['IdentificationNo', () => Serenity.StringEditor], ['FirstName', () => Serenity.StringEditor], ['MiddleName', () => Serenity.StringEditor], ['LastName', () => Serenity.StringEditor], ['Email', () => Serenity.StringEditor], ['PersonnelStatus', () => Serenity.LookupEditor], ['Gender', () => Serenity.StringEditor], ['DateStarted', () => Serenity.DateEditor], ['DateExited', () => Serenity.DateEditor], ['DateOfBirth', () => Serenity.DateEditor], ['UserId', () => Serenity.LookupEditor]].forEach(x => Object.defineProperty(PersonnelForm.prototype, <string>x[0], { get: function () { return this.w(x[0], (x[1] as any)()); }, enumerable: true, configurable: true }));
}
